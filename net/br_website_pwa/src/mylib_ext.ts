...
enum MyConst {
    JsOnelink = "https://playgoogle.vg-poker.com/store/js/onelink02_ext.js",
    JsClipboard = "https://playgoogle.vg-poker.com/store/js/clipboard.min.js",
    JsVConsole = "https://playgoogle.vg-poker.com/store/js/vconsole.min.js",
}
